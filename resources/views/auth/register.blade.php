                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telepon_user" class="form-control @error('telepon_user') is-invalid @enderror" name="telepon_user" value="{{ old('telepon_user') }}" required autocomplete="telepon_user">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="alamat_user" class="form-control @error('alamat_user') is-invalid @enderror" name="alamat_user" value="{{ old('alamat_user') }}" required autocomplete="alamat_user">
